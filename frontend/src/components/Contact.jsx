...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    },
    {
      ...
      details: [
        { text: "Main: +91 80 4123 4567", type: "main", link: "tel:+918041234567" },
        { text: "Support: +91 80 4123 4568", type: "sub", link: "tel:+918041234568" },
        { text: "Toll Free: 1800 123 4567", type: "highlight", link: "tel:18001234567" }
      ],
      color: "purple",
    ...
    },
    {
      ...
      title: "Email Us",
      details: [
        { text: "Info: info@buildveritas.com", type: "main", link: "mailto:info@buildveritas.com" },
        { text: "Support: support@buildveritas.com", type: "sub", link: "mailto:support@buildveritas.com" },
        { text: "Sales: sales@buildveritas.com", type: "highlight", link: "mailto:sales@buildveritas.com" }
      ],
      color: "indigo",
  ...
  const stats = [
    { icon: Building2, value: "10,000+", label: "Projects Completed" },
      ...
      <section className="relative overflow-hidden bg-white py-16 sm:py-24">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              Have questions about our AI-powered construction management platform? 
              We're here to help you transform your construction projects.
            </motion.p>
          </div>
        </div>
      </section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                {contactInfo.map((info, index) => (
                  ...
                  >
                    ...
                    {/* Icon */}
                    <div className={`relative inline-flex items-center justify-center w-14 h-14 rounded-2xl mb-6 bg-${info.color}-100 group-hover:scale-110 transition-transform duration-300`}>
                          ...
                          {detail.link ? (
                            <a 
                              ...
                              className={`block transition-colors duration-300 ${
                                detail.type === 'main' ? 'text-gray-800 font-medium' :
                                detail.type === 'highlight' ? 'text-blue-600 font-semibold' :
                                detail.type === 'highlight-red' ? 'text-red-500 font-medium' :
                                'text-gray-600'
                              } hover:text-blue-500`}
                            >
                              {detail.text}
      ...
      <section className="py-16 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Find quick answers to common questions about BuildVeritas</p>
          </div>
