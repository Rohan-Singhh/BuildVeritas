  ...
  const solutions = [
    {
      ...
      description:
        "Computer vision, drone imagery, and IoT sensors verify that on-site progress matches reported progress",
    },
    {
      icon: FileCheck,
      title: "Compliance Monitoring",
      description:
        "Track safety standards, environmental regulations, and legal compliance in real time",
    },
    {
      icon: Brain,
      title: "Predictive Analytics",
      description:
        "AI-driven insights identify risks like budget overruns, delays, or supply chain issues before they happen",
    },
    {
      icon: Wallet,
      title: "Smart Contracts & Payments",
      description:
        "Blockchain-based milestone payments triggered only when progress is verified",
    },
    {
      icon: Box,
      title: "Digital Twin Visualization",
      description:
        "Virtual mirror of construction site that updates automatically for live overview",
    },
  ];
  ...
  const values = [
    {
      ...
      title: "Integrity",
      description:
        "We stand for truth, accuracy, and accountability in every aspect of construction",
    },
    {
      icon: Cpu,
      title: "Innovation",
      description:
        "We harness AI, blockchain, and data to solve real-world construction challenges",
    },
    {
      icon: Sparkles,
      title: "Sustainability",
      description:
        "We promote safe, efficient, and eco-conscious construction practices",
    },
    {
      icon: Users,
      title: "Collaboration",
        ...
        >
          <div className="text-center relative max-w-5xl mx-auto">
            ...
            >
              ...
              >
                <span className="font-medium">BuildVeritas</span> is an
                AI-powered construction technology company solving one of the
                biggest challenges in the global building industry - the lack of
              ...
              >
                ...
                <p className="relative text-lg sm:text-xl text-gray-600 leading-relaxed">
                  ...
                  comes from Latin and means truth. That meaning is at the heart
                  of everything we do. We believe construction should not just
                  be about building structures; it should be about building
                  trust between clients, contractors, vendors, and investors.
                </p>
              </Motion.div>
            </Motion.div>
          </div>
              ...
              >
                <div className="relative p-6 bg-gradient-to-br from-blue-50 to-indigo-50/50 rounded-2xl">
                  ...
                  <p className="relative text-xl text-gray-700 leading-relaxed">
                    We envision a construction industry where{" "}
                    ...
                    replace guesswork, mistrust, and manual inefficiencies.
                  </p>
                </div>
                ...
                <div className="relative p-6 bg-gradient-to-br from-purple-50 to-blue-50/50 rounded-2xl">
                  ...
                  <p className="relative text-xl text-gray-700 leading-relaxed">
                    ...
                    for verification and compliance in construction - a trusted
                    platform used by
                    <span className="font-semibold text-blue-700">
                      {" "}
                      developers, governments, and investors
                    </span>{" "}
                    worldwide.
                  </p>
                </div>
            ...
            {stats.map((stat, index) => (
              ...
              >
                ...
                <Motion.div
                  ...
                  animate={
                    hoveredStat === index ? { scale: 1.1 } : { scale: 1 }
                  }
                >
                  {stat.value}
                </Motion.div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <Motion.div className="space-y-8" variants={itemVariants}>
              ...
              <Motion.p
                ...
                transition={{ delay: 0.2 }}
              >
                Existing tools in the market focus mainly on planning and
                management. They show what should happen but fail to verify what
                actually happens on the ground. This gap between reported
                progress and real progress is where mistrust and inefficiency
                thrive.
              </Motion.p>
              <Motion.div
                className="space-y-6"
              ...
              >
                {[
                  {
                    icon: Building2,
                    text: "Projects exceed budgets by 20-30%",
                    color: "from-red-400 to-orange-400",
                  },
                  {
                    icon: Award,
                    text: "25% of projects face delays",
                    color: "from-yellow-400 to-orange-400",
                  },
                  {
                    icon: Sparkles,
                    text: "Frequent compliance failures",
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
          <div className="text-center mb-20">
            ...
            <Motion.p
              ...
              transition={{ delay: 0.4 }}
            >
              BuildVeritas is not just another project management tool. It is
              the truth engine for construction.
            </Motion.p>
          </div>
            ...
            {solutions.map((solution, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Content */}
                  <Motion.h3 className="text-2xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-4 group-hover:from-blue-600 group-hover:to-purple-600 transition-all duration-300">
                    {solution.title}
                  </Motion.h3>
                  <Motion.p
                  ...
                  {/* Hover indicator */}
                  <Motion.div className="absolute bottom-0 left-0 right-0 h-1 bg-gradient-to-r from-blue-400 to-purple-500 transform scale-x-0 origin-left transition-transform duration-300 group-hover:scale-x-100" />
                </Motion.div>
              );
            })}
          </Motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              At BuildVeritas, our work is guided by four key values that shape
              everything we do.
            </p>
          </div>
            ...
            {values.map((value, index) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Content */}
                  <Motion.h3 className="text-xl font-bold bg-gradient-to-r from-gray-900 to-gray-700 bg-clip-text text-transparent mb-4 group-hover:from-blue-600 group-hover:to-purple-600 transition-all duration-300">
                    {value.title}
                  </Motion.h3>
                  <Motion.p
          ...
          <Motion.div className="text-center mb-16" variants={itemVariants}>
            ...
            <div className="max-w-3xl mx-auto space-y-6">
              <p className="text-lg text-gray-600">
                BuildVeritas is more than just a platform - it is a promise. A
                promise to bring truth, trust, and transparency into an industry
                that impacts the lives of billions of people.
              </p>
              <p className="text-lg text-gray-600">
                With BuildVeritas, construction is not just about creating
                buildings. It's about creating trust that lasts as long as the
