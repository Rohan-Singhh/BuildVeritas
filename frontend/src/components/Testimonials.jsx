...
import { Star, Quote, ArrowRight, Building2, Users, ChevronDown } from "lucide-react";
...
const testimonials = [
  {
    ...
    content: "BuildVeritas has revolutionized how we manage our construction projects. The AI-powered analytics have helped us reduce project delays by 35% and improve resource allocation significantly.",
    rating: 5,
    projectSize: "$50M+",
  ...
  },
  {
    ...
    content: "The real-time monitoring and AI safety features have transformed our site safety protocols. We've seen a 45% reduction in safety incidents since implementing BuildVeritas.",
    rating: 5,
    projectSize: "$20M-$50M",
  ...
  },
  {
    ...
    content: "The vendor marketplace feature has streamlined our procurement process completely. We're saving both time and money while working with pre-vetted, reliable suppliers.",
    rating: 5,
    projectSize: "$100M+",
  ...
  },
  {
    ...
    content: "The digital twin visualization has transformed how we communicate project progress to stakeholders. It's like having X-ray vision into our construction sites.",
    rating: 5,
    projectSize: "$10M-$20M",
  ...
  },
  {
    ...
    content: "The AI-powered safety monitoring system has been a game-changer. We can now predict and prevent potential safety issues before they occur.",
    rating: 5,
    projectSize: "$5M-$10M",
  ...
  },
  {
    ...
    content: "The automated procurement system has cut our sourcing time in half. The AI recommendations for suppliers have been surprisingly accurate.",
    rating: 5,
    projectSize: "$20M-$50M",
    industry: "Commercial Construction",
    region: "Asia Pacific"
  },
  {
    ...
    content: "The predictive analytics for project timelines have been invaluable. We're now completing projects 20% faster with better accuracy in scheduling.",
    rating: 5,
    projectSize: "$50M+",
  ...
  },
  {
    ...
    content: "The automated quality control checks have revolutionized our inspection process. We catch issues early and maintain higher standards throughout.",
    rating: 5,
    projectSize: "$10M-$20M",
    industry: "Residential Construction",
    region: "South America"
  },
  {
    ...
    content: "BuildVeritas's integration of IoT sensors with AI analytics gives us unprecedented insight into our construction operations.",
    rating: 5,
    projectSize: "$20M-$50M",
  ...
  },
  {
    ...
    content: "The environmental impact tracking features have helped us achieve LEED certification more efficiently. It's perfect for sustainable construction projects.",
    rating: 5,
    projectSize: "$5M-$10M",
...
const Testimonials = () => {
  ...
  const filteredTestimonials = testimonials.filter(testimonial => {
    return (
      ...
      (filter.projectSize === "all" || testimonial.projectSize === filter.projectSize)
    );
  });
      ...
      <section className="relative overflow-hidden bg-white py-16 sm:py-24">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            >
              Discover how BuildVeritas is transforming construction projects worldwide 
              through AI-powered innovation and real-time insights.
            </motion.p>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap gap-4 justify-center">
            ...
            <select
              ...
              onChange={(e) => setFilter({ ...filter, projectSize: e.target.value })}
              className="px-4 py-2 rounded-lg border border-gray-300 focus:ring-2 focus:ring-blue-400 focus:border-transparent"
            >
                      ...
                      >
                        <div className="grid grid-cols-3 gap-4 text-sm">
                          <div>
                            ...
                            <p className="font-medium text-gray-900">{testimonial.region}</p>
                          </div>
                          <div>
                          ...
                          <div>
                            ...
                            <p className="font-medium text-gray-900">{testimonial.projectSize}</p>
                          </div>
                        </div>
                      </motion.div>
                    )}
